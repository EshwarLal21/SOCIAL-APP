...
import 'contribution_page.dart';  // ✅ add this import if it’s in your screens directory
  ...
  Future<void> _loadPreferences() async {
    ...
    try {
      ...
      if (response != null) {
        ...
        _applyThemeFromString(_themeMode);
      }
    } catch (e) {
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            title: const Text('Earn Credits & Upgrade'),
            onTap: () {
              if (userId != null) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ContributionPage(userId: userId),
                  ),
                );
              } else {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Please login to access contribution options.')),
                );
              }
            },
          ),
